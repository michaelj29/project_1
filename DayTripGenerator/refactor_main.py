...
def day_trip_generator():
    ...
    def trip_lists(lists):
        users_do_not_like_city = True

        while users_do_not_like_city == True:
            yes_or_no = input(f"What do you like? {random.choice(lists)}? y or n?: ")
            if yes_or_no == "y":
                users_do_not_like_city = False
                random.choice(lists)
                print(f"Awesome! You selected {city}!")
    ...
    print(f'Awesome youre going to {city_choice}')
